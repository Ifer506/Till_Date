...
🐊[**Putout**](https://github.com/coderaiser/putout) plugin adds ability to convert CommonJS to ESM. Use [`@putout/plugin-nodejs`](https://www.npmjs.com/package/@putout/plugin-nodejs) instead.
